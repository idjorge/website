const seccionesPagina = new fullpage('#fullpage', {
    ...
    lazyLoad: true,
	anchors: ['programavidayministerio'], // Anclas, las usamos para identificar cada seccion y poder acceder a ellas con el menu.
	navigationTooltips: ['programavidayministerio'], // Tooltips que mostrara por cada boton.
	showActiveTooltip: true, // Mostrar tooltip activa.
	// ──────────────────────────────────────────────────
	//   :::::: Secciones
	// ──────────────────────────────────────────────────
	sectionsColor : ['#7BAABE'], // Color de fondo de cada seccion.
    slideColor: ['#1bbc9b'],
